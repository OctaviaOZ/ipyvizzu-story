<p align="center">
  ...
  <p align="center">
    ...
    · <a href="reference/ipyvizzustory/index.html">Reference</a>
...
Visit [Installation chapter](docs/installation.md) of our documentation site for more installation options and details.
...
ipyvizzu-story can be used in a wide variety of environments, visit [Environments chapter](docs/environments/index.md) of our documentation site for more details.

- Jupyter/IPython
  - [Jupyter Notebook](docs/environments/jupyter/jupyternotebook.md)
  - [Colab](docs/environments/jupyter/colab.md) [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1VnmuPHm7Ynk6aZiWN0QcnIqGGW5ODnFf?usp=sharing)
  - [Databricks](docs/environments/jupyter/databricks.md)
  - [DataCamp](docs/environments/jupyter/datacamp.md)
  - [Deepnote](docs/environments/jupyter/deepnote.md) [![View in Deepnote](https://deepnote.com/static/buttons/view-in-deepnote.svg)](https://deepnote.com/workspace/david-andras-vegh-bc03-79fd3a98-abaf-40c0-8b52-9f3e438a73fc/project/ipyvizzu-story-demo-11b5d5eb-7f68-44c4-b1a7-347fde1a8f64)
  - [JupyterLab](docs/environments/jupyter/jupyterlab.md)
  - [JupyterLite](docs/environments/jupyter/jupyterlite.md)
  - [Kaggle](docs/environments/jupyter/kaggle.md) [![Open in Kaggle](https://kaggle.com/static/images/open-in-kaggle.svg)](https://www.kaggle.com/dvidandrsvgh/ipyvizzu-story-demo)
  - [Mercury/mljar](docs/environments/jupyter/mercury.md) [![Open in Mercury](https://raw.githubusercontent.com/mljar/mercury/main/docs/media/open_in_mercury.svg)](https://huggingface.co/spaces/veghdev/ipyvizzu-story-demo)
  - [Mode](docs/environments/jupyter/mode.md)
  - [Noteable](docs/environments/jupyter/noteable.md)
  - [Voilà](docs/environments/jupyter/voila.md)
  - [VSCode Python](docs/environments/jupyter/vscode.md)
- [Streamlit](docs/environments/streamlit.md)
- [Panel](docs/environments/panel.md)
- [Python](docs/environments/python.md)
